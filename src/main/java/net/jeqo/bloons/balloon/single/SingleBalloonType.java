...
public class SingleBalloonType {
     ...
     */
    public SingleBalloonType(String key, String id, String permission, double leashHeight, double balloonHeight, String material, String color, String itemModel, String name, String[] lore) {
        this.setKey(key);
        this.setId(id);
     ...
     * @param permission        The permission required to use the balloon type, type java.lang.String
     * @param material          The name of the Bukkit Material used to create the item, type java.lang.String
     * @param itemModel         The item model name used for the balloon icon, type java.lang.String
     * @param megModelID        The ID of the MEG model to use as the balloon model, type java.lang.String
     * @param name              The name of the balloon, type java.lang.String
     * @param lore              The lore of the balloon, type java.lang.String[]
     */
    public SingleBalloonType(String key, String id, String permission, String material, String itemModel, String megModelID, String name, String[] lore) {
        this.setKey(key);
        this.setId(id);
        this.setPermission(permission);
